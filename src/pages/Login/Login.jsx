...
export default function Login() {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (rememberToken) {
        payload.remember_token = rememberToken;
      }
      ...
      if (response.data.require_otp) {
        ...
        login(response.data.user, response.data.token, rememberToken);
          ...
          <div className="auth-form-wrapper">
            ...
            {!otpStep ? (
              <>
                ...
                <p className="auth-subtitle" style={{ fontSize: '0.9rem', marginBottom: '2rem' }}>
                ...
                <form onSubmit={handleLoginSubmit}>
                  ...
                  <div className="checkbox-group space-between">
              ...
              <div className="animate-fade-in">
                <div className="otp-header">
                  ...
                  <p className="auth-subtitle" style={{ fontSize: '0.85rem' }}>
                    Enter the one-time code sent to <span className="otp-email">{formData.email}</span>
                  </p>
                </div>
            ...
            {!otpStep && (
              <p className="auth-footer" style={{ marginTop: '2rem' }}>
                New to Sangam?{' '}
                <Link to="/register" className="btn-link" style={{ fontWeight: '600' }}>
                  Create an account
                </Link>
              </p>
            )}
